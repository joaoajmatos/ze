...
_MEMORY_TABLES = [
    ...
    "memory_task_state",
    "procedure_activation_feedback",
    "procedure_action_links",
    "procedure_invocations",
    "procedure_feedback",
    "procedure_lifecycle_events",
    "procedure_provisionals",
    "procedure_versions",
...
_PERSONAL_STATE_TABLES = [
    *_MEMORY_TABLES,
    ...
    "goal_suggestions",
    "goal_learning_evidence",
    "goal_learning_reviews",
    "goal_learning_relationships",
    "goal_learning_promotions",
