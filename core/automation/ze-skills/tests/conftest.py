...
def make_pool(fetchrow=None, fetch=None, execute=None):
    """Mock asyncpg pool — mirrors core/cognition/ze-worldstate/tests/conftest.py."""
    conn = AsyncMock()
...
def make_httpx_response(
    ...
    """Mock httpx.Response — mirrors integrations/ze-browser/tests/test_browser_client.py."""
    resp = MagicMock()
