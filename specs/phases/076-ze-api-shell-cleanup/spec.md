...
- [Phase 47 — Plugin Framework](../047-plugin-framework/spec.md) — `register_proactive_jobs`, schema readiness
- [Phase 74 — Automation Substrate](../074-automation-substrate/spec.md) — why automation left ze-personal
- [Phase 07 — API](../007-api/spec.md) — original API surface (transport layer)
- [Phase 73 — API Surface](../073-api-surface/spec.md) — `/api/v0/` conventions
