...
export function DashboardStatCard({ label, value, hint }: DashboardStatCardProps) {
  return (
    <div className="px-3 py-3 rounded-2xl bg-foreground/[0.03] border border-foreground/[0.06]">
      <p className="text-base font-light text-foreground tabular-nums">{value}</p>
